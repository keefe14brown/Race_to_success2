  ...
  render(){
    return(
      <StyledBox
        ...
        <span className = 'equipment'>Hats : {this.props.equippedHelm} </span> <img src={this.props.equippedHelm} alt= " "/> <br />
        <span className = 'equipment'>Tops : {this.props.equippedArmorName} </span> <img src={this.props.equippedArmorImage} alt= " "/> <br />
        <span className = 'equipment'>Bottoms : {this.props.equippedLegs} </span> <img src={this.props.equippedLegsImage} alt= " "/><br />
